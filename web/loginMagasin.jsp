<%-- 
    Document   : loginAdministrateur
    Created on : 26 mai 2018, 23:28:41
    Author     : germinator
--%>
...
<html>
    ...
    <body>
		...
		<h1>Bienvenue à Gestion Comptable</h1>
                ...
                <br>
                <form class="form" onsubmit="return validate();" id="connexion" name="connexion" method="post" action="loginMagasin">
        ...
        <script>
            <%
                ...
                if (request.getAttribute("id")!=null) {
                    ...
                    if (id != null) {
                        response.sendRedirect("magasin.jsp");
                    }
                    else {
                        getServletContext().getRequestDispatcher("loginMagasin.jsp").forward(request, response);
                    }
                }
