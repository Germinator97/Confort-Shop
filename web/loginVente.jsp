<%-- 
    Document   : loginVente
    Created on : 29 mai 2018, 16:25:46
    Author     : germinator
--%>
...
<html>
    ...
    <body>
		...
		<h1>Bienvenue à Gestion Comptable</h1>
                ...
                <br>
                <form class="form" onsubmit="return validate();" id="connexion" name="connexion" method="post" action="loginVente">
        ...
        <script>
            <%
                ...
                if (request.getAttribute("id")!=null) {
                    ...
                    if (id != null) {
                        response.sendRedirect("ventes.jsp");
                    }
                    else {
                        getServletContext().getRequestDispatcher("loginVente.jsp").forward(request, response);
                    }
                }
