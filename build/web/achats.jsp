...
<html>
    ...
    <body style="font-family: 'Open Sans', sans-serif; height: 100vh; background: url('images/4.jpg') 50% fixed; background-size: cover;">
        ...
        <form style="position: relative; width: 60%; margin-left: 21%;" onsubmit="return validateCompte();" id="compte" name="compte" method="post" action="modificationAchat">
        ...
        <br>
        <c:forEach var="compte" begin="0" items="${comptes.rows}">
        <form style="position: relative; width: 60%; margin-left: 21%;" onsubmit="return validateUser();" id="utilisateur" name="utilisateur" method="post" action="achatModification">
                <div style="background-color: whitesmoke; width: 100%; padding-left: 6%;">
                    <div class="card-deck">
